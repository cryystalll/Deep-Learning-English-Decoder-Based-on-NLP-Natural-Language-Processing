...
## Frequency Validator
```
一般英⽂章中字⺟的出現頻率並排序 -> sort letter = ‘ETAOINSHRDLCUMWFGYPBVKJXQZ'
再來分析密⽂(UJLIALUGWLUWEMUMOVMNCNONCIHWCJBYL)中的字⺟頻率並由⼤到小排序
```
* Dictionary
```
...
* Iteration
```
列出encrypt text's letters' frequency sorting字串的所有permutation
...
```
<div align=center><img src="/img/c1.png" alt="Cover" width="60%"/></div>

<div align=center><img src="/img/c2.png" alt="Cover" width="60%"/></div>
...
```
<div align=center><img src="/img/c3.png" alt="Cover" width="60%"/></div>
...
Sort by freq
```
<div align=center><img src="/img/c4.png" alt="Cover" width="60%"/></div>

## Output Decryption to out.txt
<div align=center><img src="/img/c5.png" alt="Cover" width="60%"/></div>
